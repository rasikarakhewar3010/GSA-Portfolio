...
export const GoogleGeminiEffect = ({
  ...
  return (
    (<div className={cn("sticky top-35", className)}>
    <p
        // Responsive font sizes: 4xl on small screens, 6xl on medium, 8xl on large.
        // font-light for a thin, modern look similar to Gemini's branding.
        // text-center for horizontal alignment.
        // bg-clip-text and text-transparent are crucial for applying the gradient to the text itself.
        // bg-gradient-to-r defines a left-to-right gradient.
        // Updated color stops for a more vibrant, Gemini-like gradient.
        // drop-shadow-2xl adds a strong, visible shadow for depth.
        // tracking-tight and leading-tight reduce letter and line spacing for a compact look.
        // animate-gradient-slow applies the custom animation defined in tailwind.config.js.
        className="text-4xl sm:text-6xl lg:text-8xl font-light text-center bg-clip-text text-transparent bg-gradient-to-r from-[#076EFF] via-[#4FABFF] via-[#007BFF] via-[#a368ff] to-[#e963a2] drop-shadow-2xl tracking-tight leading-tight animate-gradient-slow"
      >
        {title || `Rasika Rakhewar`} {/* Displays the title prop or default name */}
      </p>

      {/* Description text */}
      <p
        // Responsive font sizes for the description: text-sm on small, md:text-xl on medium/large.
        // font-normal for standard weight.
        // text-center and max-w-xl mx-auto for centered, slightly wider readable width.
        // text-neutral-200 for better contrast on a dark background.
        // mt-4 for top margin.
